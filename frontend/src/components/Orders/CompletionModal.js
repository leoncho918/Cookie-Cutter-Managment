...
const CompletionModal = ({
  ...
  onClose,
  onSubmit,
  onConfirm, // NEW: Handler for confirming details
  loading,
  completionData,
  setCompletionData,
  order,
  isConfirmationStep = false, // NEW: Flag to show confirmation step
}) => {
  ...
  return (
    <Modal
      ...
      title={
        isConfirmationStep
          ? "Confirm Collection & Payment Details"
    ...
    >
      <div className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                <h4 className="text-sm font-medium text-blue-800">
                  Ready to Confirm Details
                </h4>
                <p className="text-sm mt-1 text-blue-700">
                  Please review your collection and payment details below. Once
                  confirmed, you will need admin approval to make any changes.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* NEW: Read-only summary for confirmation step OR editable form */}
        {isConfirmationStep ? (
                    ...
                    completionData.deliveryAddress.country !== "Australia" && (
                      <div className="pt-2 border-t border-gray-300">
                        <div className="text-xs text-orange-600 bg-orange-50 p-2 rounded">
                          ...
                          shipping charges and customs duties may apply for
                          delivery to {completionData.deliveryAddress.country}.
                        </div>
                      </div>
                    )}
                </div>
                  ...
                  {completionData.deliveryMethod === "Pickup" && (
                    <div className="mt-2 pt-3 border-t border-blue-200">
                      <div className="text-sm text-blue-700 space-y-1">
                        <div>
                          <strong>Address:</strong> 40A Brancourt Ave, Bankstown
                          NSW 2200
                        </div>
                        <div>
                  ...
                  {completionData.deliveryMethod === "Delivery" && (
                    <div className="mt-2 pt-3 border-t border-green-200">
                      <div className="text-sm text-green-700">
                        ...
                        <div>
                          <strong>
                            Please note that a delivery fee will be added to
                            your order total
                          </strong>
                        </div>
                        {isInternationalEnabled && (
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-blue-700 text-sm mt-1">
                            Additional delivery charges and customs duties may
                            apply for international shipments to{" "}
                            {completionData.deliveryAddress.country}. You will
                            be contacted to arrange international shipping
                            details and costs.
                          </p>
                        </div>
                      </div>
        ...
        <div className="flex justify-end space-x-4 pt-4 border-t border-gray-200">
          ...
          {isConfirmationStep ? (
            <Button
              ...
              disabled={loading}
            >
              {loading ? "Confirming..." : "Confirm & Lock Details"}
            </Button>
          ) : (
            <Button
              variant="primary"
